...
namespace Login1
{
    public partial class CustomerPanel : Window
    {
        ...
        {
            PurchaseServiceWindow purchaseServiceWindow = new PurchaseServiceWindow(customerId);
            purchaseServiceWindow.Show();
        }

        private void MakeReservationButton_Click(object sender, RoutedEventArgs e)
        {
            SelectRestaurantWindow selectRestaurantWindow = new SelectRestaurantWindow(customerId);
            selectRestaurantWindow.Show();
        }
    }
}
